      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <Card key={project.title} className="overflow-hidden animate-fade-in animate-delay-200 hover:shadow-lg transition-shadow bg-devops-darkcard border-gray-700">
              ...
              <CardHeader>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  {project.tags.length > 3 && (
                    <Badge variant="outline" className="border-gray-600 text-gray-300">+{project.tags.length - 3}</Badge>
                  )}
                </div>
              </CardHeader>
              <CardContent>
              ...
              <CardFooter>
                <Button variant="outline" className="w-full border-gray-600 text-gray-300 hover:bg-gray-800">View Case Study</Button>
              </CardFooter>
            </Card>
          ))}
        </div>
